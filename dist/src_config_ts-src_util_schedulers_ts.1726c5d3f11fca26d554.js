...
const RE_TG_LINK = /^tg2:(\/\/)?/i;
const RE_TME_LINK = /^(https?:\/\/)?([-a-zA-Z0-9@:%_+~#=]{1,32}\.)?teamgram\.me/i;
const RE_TELEGRAM_LINK = /^(https?:\/\/)?teamgram\.net\//i;
const TME_LINK_PREFIX = 'https://teamgram.me/';
...
const TME_WEB_DOMAINS = new Set(['teamgram.me', 'web.teamgram.me', 'a.teamgram.me', 'k.teamgram.me', 'z.teamgram.me']);
...
const MINI_APP_TOS_URL = 'https://teamgram.net/tos/mini-apps';
const FRAGMENT_ADS_URL = 'https://teamgram.net/fragment/ads';
