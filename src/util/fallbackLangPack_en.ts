...
export default {
  ...
  TelegramFeatures: 'Tadpole Features',
  ...
  Username: 'Username',
  UsernameHelp: 'You can choose a username on **Tadpole**. If you do, people will be able to find you by this username and contact you without needing your phone number.\n\nYou can use **a–z**, **0–9** and underscores. Minimum length is **5** characters.',
  ...
  PhoneOther: 'Other',
  ContactJoined: 'Contact joined Tadpole',
  ...
  lng_settings_sensitive_about: 'Display sensitive media in public channels on all your Tadpole devices.',
  ...
  EnabledPasswordText: 'You have enabled Two-Step verification.\nYou\'ll need the password you set up here to log in to your Tadpole account.',
  ...
  'Channel.Username.CreatePublicLinkHelp': 'People can share this link with others and find your channel using Tadpole search.',
  ...
  'Group.Username.CreatePublicLinkHelp': 'People can share this link with others and find your group using Tadpole search.',
  ...
  lng_update_telegram: 'Update Tadpole',
  ...
  'Video.Unsupported.Desktop': 'Unfortunately, this video can\'t be played on Tadpole Web. Try opening it with our **desktop app** instead.',
  'Video.Unsupported.Mobile': 'Unfortunately, this video can\'t be played on Tadpole Web. Try opening it with our **mobile app** instead.',
